...
<jsp:include page="header.jsp"></jsp:include>
	<form action="/employee/employeeRegister" method="post">
		<div class="row wls-contact-mid">
			...
			<div class="col-md-6 col-sm-6 form-group contact-forms">
				<input type="email" class="form-control"
					placeholder="Employee Email" required="" name="empEmail" value="${employeeEdit.empEmail}">
			</div>
		</div>
		...
		<div class="row wls-contact-mid">
			...
			<div class="col-md-6 col-sm-6 form-group contact-forms">
				<select class="form-control" name="jobTitle" value="${employeeEdit.jobTitle}">
		...
		<div class="row agile-wls-contact-mid">
			...
			<div class="col-md-6 col-sm-6 form-group contact-forms">
				<span>Date Of Birth</span> <input type="date" class="form-control"
					placeholder="Date Of Birth" required="" name="birthDate" value="${employeeEdit.birthDate}">
			</div>
			<div class="col-md-6 col-sm-6 form-group contact-forms">
				<span>join Date</span> <input type="date" class="form-control"
					placeholder="Join Date" required="" name="joinDate" value="${employeeEdit.joinDate}">
			</div>
		</div>
